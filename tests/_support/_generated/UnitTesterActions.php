<?php  //[STAMP] cafb182ba715ba2f64a7be1b3b524704
...
trait UnitTesterActions
{
     ...
     * @see \Helper\All::removeCommandsDirectory()
     */
    public function removeCommandsDirectory() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('removeCommandsDirectory', func_get_args()));
    }
     ...
     * @see \Helper\All::getDirectoryCreator()
     */
    public function getDirectoryCreator($logger) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getDirectoryCreator', func_get_args()));
    }
