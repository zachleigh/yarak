<?php  //[STAMP] f937c6bd2824f12f817d17b67c19cb56
...
trait UnitTesterActions
{
     ...
     *
     * @param Users $user
     * @see \Helper\Assertations::assertUserInstanceMade()
     */
     ...
     * @param Users $user
     * @param Actor $tester
     * @see \Helper\Assertations::assertUserInstanceCreated()
     */
     ...
     * @param Users $user
     * @param array $attributes
     * @see \Helper\Assertations::assertUserHasAttributes()
     */
     ...
     * @see \Helper\Assertations::assertTablesEmpty()
     */
     ...
     * @see \Helper\Assertations::assertTablesCount()
     */
     ...
     * @return $this
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Helper\Assertations::seeTableIsEmpty()
     */
     ...
     * @return $this
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Helper\Assertations::seeTableExists()
     */
     ...
     * @return $this
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Helper\Assertations::seeTableDoesntExist()
     */
     ...
     *
     * @param array $paths
     * @see \Helper\Assertations::assertAllPathsDontExist()
     */
    public function assertAllPathsDontExist($paths) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('assertAllPathsDontExist', func_get_args()));
    }
     ...
     *
     * @param array $paths
     * @see \Helper\Assertations::assertAllPathsExist()
     */
    public function assertAllPathsExist($paths) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('assertAllPathsExist', func_get_args()));
    }
     ...
     * @see \Helper\Builder::getMigrator()
     */
     ...
     * @see \Helper\Builder::getMigrationCreator()
     */
     ...
     * @see \Helper\Builder::getSeederCreator()
     */
     ...
     * @see \Helper\Builder::getCommandCreator()
     */
     ...
     * @see \Helper\Builder::getDBDirectoryCreator()
     */
     ...
     * @see \Helper\Builder::getConsoleDirectoryCreator()
     */
     ...
     *
     * @return ModelFactory
     * @see \Helper\Builder::getModelFactory()
     */
     ...
     * @see \Helper\Database::resetDatabase()
     */
    public function resetDatabase() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('resetDatabase', func_get_args()));
    }
     ...
     * @see \Helper\Database::getConnection()
     */
     ...
     * @see \Helper\Filesystem::setFilesystem()
     */
    public function setFilesystem() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('setFilesystem', func_get_args()));
    }
     ...
     * @see \Helper\Filesystem::removeDatabaseDirectory()
     */
     ...
     * @see \Helper\Filesystem::removeMigrationDirectory()
     */
     ...
     * @see \Helper\Filesystem::removeSeedDirectory()
     */
     ...
     * @see \Helper\Filesystem::removeFactoryDirectory()
     */
     ...
     * @see \Helper\Filesystem::removeConsoleDirectory()
     */
     ...
     *
     * @return Filesystem
     * @see \Helper\Filesystem::getFilesystem()
     */
     ...
     *
     * @return string
     * @see \Helper\Filesystem::getFileNameFromPath()
     */
     ...
     *
     * @param Config $config
     * @see \Helper\Filesystem::createAllPaths()
     */
     ...
     * @see \Helper\Filesystem::makeDirectoryStructure()
     */
     ...
     *
     * @throws WriteError
     * @see \Helper\Filesystem::writeFile()
     */
     ...
     * @see \Helper\Filesystem::copySeeders()
     */
    public function copySeeders() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('copySeeders', func_get_args()));
    }
     ...
     *
     * @param Config $config
     * @see \Helper\Filesystem::copyStubs()
     */
    public function copyStubs($config) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('copyStubs', func_get_args()));
    }
     ...
     * @param string $fileName
     * @see \Helper\Filesystem::copyModelStub()
     */
    public function copyModelStub($stubName, $fileName) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('copyModelStub', func_get_args()));
    }
     ...
     *
     * @param string $stubName
     * @see \Helper\Filesystem::copySeederStub()
     */
    public function copySeederStub($stubName) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('copySeederStub', func_get_args()));
    }
     ...
     * @see \Helper\Filesystem::copyKernelStub()
     */
    public function copyKernelStub() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('copyKernelStub', func_get_args()));
    }
     ...
     * @see \Helper\Filesystem::copyCommands()
     */
    public function copyCommands() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('copyCommands', func_get_args()));
    }
     ...
     *
     * @return string
     * @see \Helper\Main::createMigration()
     */
     ...
     * @see \Helper\Main::createSingleStep()
     */
     ...
     *
     * @param Yarak\Migrations\Migrator $migrator
     * @see \Helper\Main::createTwoSteps()
     */
